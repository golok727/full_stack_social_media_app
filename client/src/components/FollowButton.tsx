		...
		<button
			className={` ${
				isFollowing
					...
					: "bg-gradient-to-r from-violet-800 to to-pink-500 hover:bg-blue-800 text-white"
			} rounded px-3 py-1  font-bold text-sm disabled:text-gray-200 disabled:bg-gray-700`}
